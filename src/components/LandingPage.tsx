      ...
      <nav className="relative z-50 border-b border-white/10 bg-[#1a1a1a]/50 backdrop-blur-xl sticky top-0">
        <div className="max-w-[1400px] mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <SignedOut>
                <SignInButton mode="modal" forceRedirectUrl="https://redesigneastudyappdashboard.vercel.app/dashboard">
                ...
                <SignUpButton mode="modal" forceRedirectUrl="https://redesigneastudyappdashboard.vercel.app/dashboard">
