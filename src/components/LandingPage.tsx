      ...
      <nav className="relative z-50 border-b border-white/10 bg-[#1a1a1a]/50 backdrop-blur-xl sticky top-0">
        <div className="max-w-[1400px] mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <SignedOut>
                <SignInButton mode="modal" fallbackRedirectUrl="https://redesigneastudyappdashboard.vercel.app/dashboard">
                ...
                <SignUpButton mode="modal" fallbackRedirectUrl="https://redesigneastudyappdashboard.vercel.app/dashboard">
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-white/[0.08] to-white/[0.03] backdrop-blur-xl rounded-[32px] border border-white/20 p-8 shadow-2xl">
                <div className="space-y-6">
                  {/* Mini ReadyScore Gauge Preview */}
                  <div className="bg-gradient-to-br from-[#FF8C00]/10 to-white/5 rounded-2xl p-6 border border-[#FF8C00]/30">
                    ...
                    <div className="mt-2 h-2 bg-white/10 rounded-full overflow-hidden">
                      <div className="h-full w-[67%] bg-gradient-to-r from-[#FF8C00] to-[#50FA7B]" />
                    </div>
                    <p className="mt-3 text-sm text-[#50FA7B]">↑ +12 points this week</p>
                  </div>

                  {/* AI Mentor Preview */}
                  <div className="bg-gradient-to-br from-white/[0.08] to-white/[0.03] rounded-2xl p-6 border border-white/10">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="p-2 bg-gradient-to-br from-[#BD93F9] to-[#D4B3FF] rounded-lg">
                        <Brain className="w-4 h-4 text-white" />
                      </div>
                      <span className="text-white font-semibold">AI Mentor</span>
                      <span className="ml-auto px-2 py-1 bg-[#50FA7B]/20 border border-[#50FA7B]/30 rounded-lg text-xs text-[#50FA7B]">
                        Active
                      </span>
                    </div>
                    <div className="space-y-3">
                      <div className="bg-[#BD93F9]/10 border border-[#BD93F9]/30 rounded-xl p-3">
                        <p className="text-sm text-slate-300">Let's focus on Partnership Basis today. You're making great progress!</p>
                      </div>
                      <div className="flex gap-2">
                        <button className="flex-1 px-3 py-2 bg-white/5 hover:bg-white/10 border border-white/20 rounded-lg text-xs text-white transition-colors">
                          Start Lesson
                        </button>
                        <button className="flex-1 px-3 py-2 bg-gradient-to-r from-[#FF8C00] to-[#FFA500] text-white rounded-lg text-xs font-semibold transition-all">
                          Take Quiz
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-white/[0.08] to-white/[0.03] rounded-2xl p-6 border border-white/10">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-lg font-bold text-[#50FA7B]">Top 5%</p>
